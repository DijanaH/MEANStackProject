...
@Component({
  selector: 'app-oglasivac-nekretnine',
  templateUrl: './oglasivac-nekretnine.component.html',
  styleUrls: ['./oglasivac-nekretnine.component.css']
})
export class OglasivacNekretnineComponent implements OnInit {
